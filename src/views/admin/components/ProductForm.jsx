...
const ProductForm = ({ product, onSubmit, isLoading, category }) => {
  const brandOptions = category.map(item => ({ value: item, label: item }))
  ...
  const onSubmitForm = (form) => {
    if (imageFile.image.file || product.image) {
      ...
      console.log(imageFile.image.file, product.image);
      // addCategory();
    } else {
